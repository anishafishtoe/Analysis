...
gud.mPhase=with(gMean, describeBy(meanGUD, moonPhase, mat=T, digits=4))
...
gud.hab=with(gMean, describeBy(meanGUD, habitat, mat=T, digits=4))
...
gud.mhab=with(gMean, describeBy(meanGUD,feedingTrayPosition , mat=T, digits=4))
...
gud.month=with(gMean, describeBy(meanGUD,month , mat=T, digits=4))
...
mPhase.trayPos.summary=with(gMean,describeBy(meanGUD, list(moonPhase, FeedingTrayPosition), mat=T, digits=2))
...
mPhase.hab.summary=with(gMean,describeBy(meanGUD, list(moonPhase, habitat), mat=T, digits=4))
...
hab.micro.summary=with(gMean,describeBy(meanGUD, list(habitat, FeedingTrayPosition), mat=T, digits=4))
...
hab.mon.summary=with(gMean,describeBy(meanGUD, list(habitat, month), mat=T, digits=4))
...
mon.hab.muhab.summary=with(gMean,describeBy(meanGUD, list(month, habitat, feedingTrayPosition), mat=T, digits=4))
...
mPhase.hab.muhab.summary=with(gMean,describeBy(meanGUD, list(moonPhase, habitat, feedingTrayPosition), mat=T, digits=4))
